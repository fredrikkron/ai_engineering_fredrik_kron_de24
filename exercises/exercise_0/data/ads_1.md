...
Instabee is looking for a Data Engineer with an interest in Analytics Engineering to join their newly formed Data Platform team, which utilizes a modern data stack including GCP, Snowflake, and DBT. This role involves shaping the data platform for diverse uses like BI, data science, and product integration, focusing on data ingestion, infrastructure, and robust data modeling. The ideal candidate has experience in both Data and Analytics Engineering, a technical background, thrives on collaboration, and enjoys a dynamic, hybrid work environment in Stockholm with appealing benefits.
