...
Instabee, a rapidly expanding last-mile delivery company, is seeking a Data Engineer with significant interest and experience in Analytics Engineering for their newly formed Data Platform team. This role involves shaping and building a modern data platform using GCP, Snowflake, DBT, and Python, to integrate diverse data sources and model data for BI, data science, and product use cases. The position, based in Stockholm with a hybrid work model, offers a dynamic environment with cutting-edge tech and attractive benefits.
